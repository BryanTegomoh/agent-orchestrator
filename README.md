...
The walkthroughs live in [docs/guide.md](docs/guide.md): wiring a provider, task graphs, goal loops, routing, memory, and screening. Operational notes are in [docs/operations.md](docs/operations.md).
